...
def recipe(recipe_id):
    ...
    if current_user.is_authenticated:
        ...
        rating_value = None, bookmark_button= 'not-saved', number_steps= number_steps, drinks = drinks, photos = photos, user_photos= user_photos)
    
    return render_template('recipe/recipe.html', recipe=recipe, rating_button = rating_button,
    rating_value = rating_value, bookmark_button= bookmark_button, number_steps= number_steps, drinks = drinks, photos = photos,user_photos=user_photos)
